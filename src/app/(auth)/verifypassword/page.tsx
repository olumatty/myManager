...
const ForgetPassword = () => {
  ...
  const handleInputChange = (index: number, value: string) => {
    // Fixed the logic - should only take the last character for single digit input
      ...
      <div className="flex w-full items-center justify-center p-4 sm:p-6 md:w-1/2 md:p-8 lg:p-16">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center space-y-3">
            <h1 className="text-xl font-semibold text-[#303030] sm:text-2xl md:text-3xl leading-tight">
              Check your email for the verification code
            </h1>
            <p className="text-sm text-[#6d47ff] sm:text-base">
              Enter the verification code we sent to your email address.
            </p>
            <p className="text-sm text-[#303030] font-semibold sm:text-base">
          ...
          <div className="flex justify-center gap-2 sm:gap-3">
            {otp.map((item, index) => (
              <input
                ...
                value={item}
                className="w-12 h-12 sm:w-14 sm:h-14 text-center text-lg sm:text-xl font-bold text-purple-600 border-2 border-gray-300 rounded-md focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          ...
          <div className="text-center">
            {countdown > 0 ? (
              <p className="text-sm text-gray-500 sm:text-base">
                Resend Code in{" "}
                <span className="text-[#6d47ff] font-medium">
              ...
              <button
                ...
                className="text-sm sm:text-base text-purple-600 hover:text-purple-800 transition-colors duration-200 hover:opacity-80 font-medium"
              >
                Resend Code
              </button>
            )}
          ...
          {/* Terms and Privacy */}
          <p className="text-center text-xs text-gray-500 sm:text-sm leading-relaxed">
